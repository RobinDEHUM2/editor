...
public class Builder {
    ...
    public static Document createGrid(Point origin, int line, int column, double length) {
    ...
    public static Document createCircles(Point center, int number, double radius, double delta) {
        Document doc = new Document();
